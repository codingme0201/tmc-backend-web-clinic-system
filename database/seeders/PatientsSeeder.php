...
class PatientsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $patients = [
            ...
            ['patient_id' => 'EMP-042', 'name' => 'Alberto Ruiz', 'type' => 'Student', 'course_dept' => 'College of Engineering', 'contact' => '+63 944 123 9876', 'emergency_contact' => 'Elena Ruiz (Wife) - +63 944 123 9870', 'allergies' => 'Aspirin', 'history' => 'Hypertension', 'status' => 'Active'],
            ['patient_id' => 'EMP-119', 'name' => 'Susan Clave', 'type' => 'Student', 'course_dept' => 'BS Business Administration', 'contact' => '+63 955 456 7890', 'emergency_contact' => 'Robert Clave (Husband) - +63 955 456 7891', 'allergies' => 'Seafood', 'history' => 'None', 'status' => 'Active'],
