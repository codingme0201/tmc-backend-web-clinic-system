...
class PatientsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $patients = [
            ...
            ['patient_id' => '23-010042', 'name' => 'Alberto Ruiz', 'type' => 'Student', 'course_dept' => 'BS Mechanical Engineering', 'contact' => '+63 944 123 9876', 'emergency_contact' => 'Elena Ruiz (Mother) - +63 944 123 9870', 'allergies' => 'Aspirin', 'history' => 'Hypertension', 'status' => 'Active'],
            ['patient_id' => '23-010119', 'name' => 'Susan Clave', 'type' => 'Student', 'course_dept' => 'BS Business Administration', 'contact' => '+63 955 456 7890', 'emergency_contact' => 'Robert Clave (Father) - +63 955 456 7891', 'allergies' => 'Seafood', 'history' => 'None', 'status' => 'Active'],
